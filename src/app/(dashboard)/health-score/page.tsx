...
const emergencyFundMonths = 19400 / summary.monthlyExpenses;
...
export default function HealthScorePage() {
  return (
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-col items-center justify-center w-28 h-28 rounded-full border-4 flex-shrink-0"
          style={{ borderColor: gradeColors[health.grade] }}
        >
          <span
            className="text-4xl font-bold"
            style={{ color: gradeColors[health.grade] }}
          >
            {health.grade}
          </span>
